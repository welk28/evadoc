...
<div id="cuerpo">
	...
	<section id="seccion">
        ...
        $cerrado="select cierre from periodo where predet=1";
        $cerr=mysql_query($cerrado,$conexion);
        $cr=mysql_fetch_object($cerr);
				...
				{					
					...
					<tr>
						...
						<td>"; 
            if($cr->cierre){
            echo"<a href='desglose.php?idh=$h->idh&idoc=$h->idoc' target='_blank'>Ver</a>";
            }
            echo"</td>
					</tr>
					";
