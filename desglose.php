            ...
            <?php 
				...
				{		
						...
						{	
							...
							$numpreuno="select * from pregunta as p, cierre as r where p.nop=r.nop and p.nomod=$mo->nomod and p.nop=$pr->nop and r.idh=$idh";
							$npuno=mysql_query($numpreuno,$conexion);
							$dp=mysql_fetch_object($npuno);
							...
							<tr>
								<td>$pr->nop</td>
								<td>$pr->pregunta</td>
								<td class='resul'>$dp->uno 		<br>"; 		$r1=($dp->uno*$mo->p1)/$do->num;  $sumr+=$r1; printf("%0.2f",$r1); echo"</td>
								<td class='resul'>$dp->dos 		<br>"; 		$r2=($dp->dos*$mo->p2)/$do->num;  $sumr+=$r2; printf("%0.2f",$r2); echo"</td>
								<td class='resul'>$dp->tres 	<br>"; 		$r3=($dp->tres*$mo->p3)/$do->num;  $sumr+=$r3; printf("%0.2f",$r3); echo"</td>
								<td class='resul'>$dp->cuatro <br>"; 		$r4=($dp->cuatro*$mo->p4)/$do->num;  $sumr+=$r4; printf("%0.2f",$r4); echo"</td>
								<td class='resul'>$dp->cinco 	<br>"; 		$r5=($dp->cinco*$mo->p5)/$do->num;  $sumr+=$r5; printf("%0.2f",$r5); echo"</td>
