...
<div id="cuerpo">
	<header id="cabecera">
		...
		if($modifica==1)
		{
			$modifcant="update cierre set uno='$uno', dos='$dos', tres='$tres', cuatro='$cuatro', cinco='$cinco' where idh='$idh' and nop='$nump';";
        ...
        <div id="evadoc" >
            ...
            <?php 
				...
				while($mo=mysql_fetch_object($modu))
				{
						...
						{
							$preg1="select * from cierre where idh='$idh' and nop=$pr->nop";
							$pre1=mysql_query($preg1,$conexion);
							$dp=mysql_fetch_object($pre1);
							echo"
							...
							<tr>
								...
								<input type='hidden' name='idh' size='2' value='$idh'>
								<input type='hidden' name='nump' size='2' value='$pr->nop'>
								$pr->nop
								</td>
								<td>$pr->pregunta</td>
								<td class='resul'><input type='text' name='uno' size='2' value='$dp->uno'></td>
								<td class='resul'><input type='text' name='dos' size='2' value='$dp->dos'></td>
								<td class='resul'><input type='text' name='tres' size='2' value='$dp->tres'></td>
								<td class='resul'><input type='text' name='cuatro' size='2' value='$dp->cuatro'></td>
								<td class='resul'><input type='text' name='cinco' size='2' value='$dp->cinco'></td>
								<td align='center'>";$suma=0; $suma=$dp->uno+$dp->dos+$dp->tres+$dp->cuatro+$dp->cinco; echo"$suma</td>
